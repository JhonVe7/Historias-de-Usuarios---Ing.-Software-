...
$password = " ";
$puerto = 3306;
    $con= @mysql_connect($hostname, $username, $password,$puerto); or die("No se pudo conectar a la Base de datos1");
    $db = mysql_select_db($con,$database)or die ( "No se ha podido conectar a la base de datos" );
*/
class Conect_MySql {   
     var $obj = array ( "dbname"	=>	"documentos2",
                       "dbuser"		=>	"root"		,
                       "dbpwd"		=>	""		,
                       "dbhost"		=>	"localhost"	);
